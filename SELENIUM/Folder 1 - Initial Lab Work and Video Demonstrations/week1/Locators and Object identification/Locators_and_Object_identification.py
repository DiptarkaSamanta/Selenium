...
try:
    ...
    animals_dropdown = Select(driver.find_element(By.NAME, "animals"))
    animals_dropdown.select_by_visible_text("Cat")

    # 2. By.TAG_NAME, By.LINK_TEXT, By.CLASS_NAME
    main_heading = driver.find_element(By.TAG_NAME, "h1")
    home_link = driver.find_element(By.LINK_TEXT, "Home")
    radio_label = driver.find_element(By.CLASS_NAME, "form-check-label")
    radio_label.click()

    # 3. find_elements
    input_elements = driver.find_elements(By.CLASS_NAME, "form-control")

    # 4. CSS Selectors & Wildcards
    email_css = driver.find_element(By.CSS_SELECTOR, "input#email")
    name_starts_with = driver.find_element(By.CSS_SELECTOR, "input[id^='nam']")
    email_ends_with = driver.find_element(By.CSS_SELECTOR, "input[id$='mail']")
    phone_contains = driver.find_element(By.CSS_SELECTOR, "input[id*='phon']")
    direct_child = driver.find_element(By.CSS_SELECTOR, "div.form-group > input#name")
    descendant = driver.find_element(By.CSS_SELECTOR, "div#header-inner h1")
